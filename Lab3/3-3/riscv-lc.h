...
#define get_J(x)                                                                                                       \
    ((get_element_of((x), J6) << 6) + (get_element_of((x), J5) << 5) + (get_element_of((x), J4) << 4) +                \
     (get_element_of((x), J3) << 3) + (get_element_of((x), J2) << 2) + (get_element_of((x), J1) << 1) +                \
     (get_element_of((x), J0)))
...
#define get_ADDR1MUX(x) ((get_element_of((x), ADDR1MUX1) << 1) + (get_element_of((x), ADDR1MUX0)))
#define get_ADDR2MUX(x) ((get_element_of((x), ADDR2MUX1) << 1) + (get_element_of((x), ADDR2MUX0)))
...
static const char *regs[] = {"zero", "ra", "sp", "gp", "tp",  "t0",  "t1", "t2", "fp/s0", "s1", "a0",
